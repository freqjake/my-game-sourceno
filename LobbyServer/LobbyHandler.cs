...
namespace EpinelPS.LobbyServer
{
    public static class LobbyHandler
    {
        ...
        {
            // 1. Tell the server to count how many characters are locked today!
            ...
            NetUserData ret = new()
            {
                ...
                // 2. Subtract the locked characters from your max of 3
                CounselCount = (short)Math.Max(0, 3 - usedTickets),
            };
